// Sourced from: https://github.com/typetools/checker-framework/pull/6084.
// There is another test case in this PR, but this one looks like the one
// that was reduced from the original report (which mentions an IndexMode.java).
