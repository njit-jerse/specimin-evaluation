// Sourced from https://github.com/typetools/checker-framework/issues/293#issuecomment-164221591.
// Issue 1291 was closed as a duplicate of that issue, referencing that comment; this whole
// test case was added at the same time. Based on the comments below, I think this "test case"
// is actually a collection of 14 tests, not a single minimized repro. Since presumably just one
// is needed to repro #1291 (but we don't know which), and they're about the same size, in
// the table in the paper we've put the _average size_ of the tests in this file, by
// dividing the line count of the file by 14.
